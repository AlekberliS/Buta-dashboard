  ...
  return (
    <div className="p-6">
       ...
       <nav className="space-y-2">
         <Link to="/menu/dashboard" className="block text-blue-500 hover:underline">
           Dashboard
         </Link>
         <Link to="/menu/calendar" className="block text-blue-500 hover:underline">
           Calendar
        </Link>
        <Link to="/menu/members" className="block text-blue-500 hover:underline">
          Members
        </Link>
      </nav>
